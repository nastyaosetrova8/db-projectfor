...
router.get("/:supplierId", isValidId, ctrl.getById);

router.post("/", validateBody(schemas.addSchema), ctrl.add);
router.put("/:supplierId", isValidId, validateBody(schemas.addSchema), ctrl.updateById);
// router.patch("/:customerId/favorite", isValidId, validateBody(schemas.updateFavoriteSchema), ctrl.updateFavorite);

router.delete("/:supplierId", isValidId, ctrl.deleteById);
